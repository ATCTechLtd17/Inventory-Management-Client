...
const AddBook = () => {
  ...
  return (
    <div className="bg-white p-6 shadow-md text-black mx-auto">
      <h2 className="md:text-2xl font-extrabold mb-6 text-teal-900">
        Add Your Product
      </h2>
      <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white border border-gray-700 rounded text-black focus:ring-2 focus:ring-indigo-500"
        ...
        <div>
          ...
          <input
            ...
            value={purchaseValue}
            readOnly
            className="w-full px-3 py-2 border border-gray-700 rounded text-gray-500 cursor-not-allowed"
      ...
      <div className="grid grid-cols-2 ">
          ...
          {bookImage && (
            <div>
              <img src={bookImage} 
              alt="Product Preview" 
              className="w-40 h-60 my-5  object-cover rounded-lg shadow-lg border-2 border-gray-300"/>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="col-span-full">
          <button
            ...
            className="w-full bg-gradient-to-r from-gray-800 to-purple-600 hover:bg-purple-600 text-white font-semibold py-2 rounded focus:ring-2 focus:ring-indigo-500"
          >
            Add Product
          </button>
        </div>
